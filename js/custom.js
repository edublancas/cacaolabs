...
$("#contact").submit(function (e) {
    ...
    var validMessage = (message.length > 1);
    ...
    if(!validName){
        $('.error_name').fadeIn(1000);
    }else{
        $('.error_name').fadeOut(1000);
    }

    if (validEmail(email) && validMessage && validName) {
        var request = $.ajax({
            type: "POST",
            url: "http://getsimpleform.com/messages?form_api_token=0a6a2644f82ae197fe8b48678532cca0",
            data: dataString,
        });
